...
export default function RegisterLawyer() {
  ...
  return (
    <div className="container mx-auto px-4 py-16">
      <h1 className="text-3xl font-bold mb-8 text-center">Register as a Lawyer</h1>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value) => handleChange({ target: { name: "specialization", value } })}
                >
              ...
              <div>
                <label htmlFor="courtLevel" className="block text-sm font-medium text-gray-700 mb-1">
                  Court Level
                </label>
                <Select
                  name="courtLevel"
                  value={formData.courtLevel}
                  onValueChange={(value) => handleChange({ target: { name: "courtLevel", value } })}
                >
                  <SelectTrigger className="w-full">
